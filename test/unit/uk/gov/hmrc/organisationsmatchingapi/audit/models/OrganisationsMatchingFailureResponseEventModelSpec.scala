...
class OrganisationsMatchingFailureResponseEventModelSpec extends AnyWordSpec with Matchers {
  "Serializes to Json Correctly" in {
    val eventModel = OrganisationsMatchingFailureResponseEventModel(
      "test",
      "test",
      "test",
      "test",
  ...
  "Deserializes to Json Correctly" in {
    ...
    val result = Json.fromJson[OrganisationsMatchingFailureResponseEventModel](json)

    result.get shouldBe OrganisationsMatchingFailureResponseEventModel(
      "test",
      "test",
      "test",
      "test",
